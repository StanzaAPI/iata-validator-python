...
class IataValidatorClient:
    """Official zero-dependency client for IATA Air Cargo AWB & Aviation Validator."""
    ...
    def __init__(
        ...
        self.tier = tier
        self.base_url = (base_url or "https://api.stanzaapi.com/iata-validator").rstrip("/")
        self.validate_endpoint = "/api/v1/validate"
        self.parse_endpoint = "/api/v1/validate"
        self.timeout = timeout
        self.tool_url = "https://stanzaapi.com/tools/iata-validator"
    ...
    def _request(self, endpoint: str, method: str = "GET", body: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        headers = {
            ...
            "User-Agent": "stanzaapi-iata-validator-python/1.0.0"
        }
        if self.api_key:
